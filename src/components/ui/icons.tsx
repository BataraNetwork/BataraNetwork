...
export const RocketIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M17.5 7.5c1.5-1.26 2-5 2-5s-3.74.5-5 2c-.71.84-.7 2.3-.05 3.1s2.15 1.5 2.55 1.4z"></path>
        <path d="M9 12l-2 2-2 2"></path><path d="M15 12l2 2 2 2"></path>
        <path d="M7.5 2.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S8.21 1.66 7.5 2.5z"></path>
        <path d="M14.5 21.5c1.5-1.26 2-5 2-5s-3.74.5-5 2c-.71.84-.7 2.3-.05 3.1s2.15 1.5 2.55 1.4z"></path>
    </svg>
);