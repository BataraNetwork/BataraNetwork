import { createHash, generateKeyPairSync, createSign, createVerify, createPrivateKey } from 'crypto';
...
/**
 * Validates if a given string is a valid PEM-encoded private key.
